...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en">
<body>
  <header className="w-full border-b bg-white" style="padding-top:30px;">
    <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3 md:px-8 container stack">
      <img
